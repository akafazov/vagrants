...
## Configuring FRR
# Change the IP of the neighbor (dc1-gw) in line "neighbor 213.131.230.19 peer-group uplink"
...
router bgp 64999
  ...
  neighbor 213.131.230.19 peer-group uplink
