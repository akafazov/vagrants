...
## Configuring FRR
# Change the IP of the neighbors (dc2-gw & cloud-1) in lines starting with "neighbor" and IP
...
router bgp 64999
  ...
  neighbor 213.131.230.104 peer-group downlink
  neighbor 213.131.230.183 remote-as 65000
  neighbor 213.131.230.183 ebgp-multihop 20
  ...
  address-family ipv4 unicast
    ...
    neighbor 213.131.230.183 activate
    neighbor 213.131.230.183 soft-reconfiguration inbound
    neighbor 213.131.230.183 route-map ALLOW_ALL in
    neighbor 213.131.230.183 route-map ALLOW_ALL in
  exit-address-family
